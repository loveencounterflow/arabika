...
(function() {
  var BNP, NEW, R, TRM, XRE, alert, badge, current_level, d, debug, dents, echo, ending, help, indentation, info, level, line, line_idx, lines, log, material, rainbow, rpr, source, warn, whisper, π, _i, _len;
  ...
  for (line_idx = _i = 0, _len = lines.length; _i < _len; line_idx = ++_i) {
    ...
    if (level > current_level) {
      ...
      while (level > current_level) {
        current_level += 1;
        dents.push(this.$_constants['opener']);
      }
      R.push(dents.join(''));
      ...
      while (current_level > level) {
        current_level -= 1;
        dents.push(this.$_constants['closer']);
      }
      R.push(dents.join(''));
    }
    R.push('.' + material);
