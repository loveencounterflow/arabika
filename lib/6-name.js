...
(function() {
  ...
  this.$new.identifier_with_sigil = function(G, $) {
    ...
    R = R.onMatch(function(match, state) {
      show('name', state);
      return G.x_identifier_with_sigil(match[0], match[1] + match[2]);
    });
  ...
  this.$new.identifier_without_sigil = function(G, $) {
    ...
    R = R.onMatch(function(match, state) {
      show('$name', state);
      return G.x_identifier_without_sigil(match[0] + match[1]);
    });
  ...
  this.$new.x_symbol = function(G, $) {
    return function(mark, raw, value) {
      var R;
  ...
  this.$new.x_relative_route = function(G, $) {
    return function(raw, value) {
      var R;
  ...
  this.$new.x_identifier_with_sigil = function(G, $) {
    return function(sigil, name) {
      var R;
  ...
  this.$new.x_identifier_without_sigil = function(G, $) {
  ...
  this.$new.relative_route = function(G, $) {
    ...
    R = R.onMatch(function(match) {
      ...
      return G.x_relative_route(raw, match);
    });
  ...
  this.$new.as = function(G, $) {
    var as;
    as = {};
    as.standard = function(node) {
      var R, crumb, crumb_subtype, crumb_type, crumbs, idx, name, property, subtype, type, _i, _len;
          ...
          switch (subtype = node['x-subtype']) {
            case 'relative-route':
              ...
              for (idx = _i = 0, _len = crumbs.length; _i < _len; idx = ++_i) {
                ...
                if (crumb_subtype !== 'identifier-without-sigil') {
  ...
  this.$TESTS = {
    ...
    'as.standard: standardize route': function(test) {
      ...
      /* TAINT test will fail for Unicode 32bit code points */
      var $, ESCODEGEN, G, node, result, source;
      ...
      return info(ESCODEGEN.generate(result));
    }
  };
