...
(function() {
  ...
  this.$new.identifier_with_sigil = function(G, $) {
    ...
    R = R.onMatch(function(match, state) {
      show('name', state);
      return G.new_node.x_identifier_with_sigil(match[0], match[1] + match[2]);
    });
  ...
  this.$new.identifier_without_sigil = function(G, $) {
    ...
    R = R.onMatch(function(match, state) {
      show('$name', state);
      return G.new_node.x_identifier_without_sigil(match[0] + match[1]);
    });
  ...
  this.$new.relative_route = function(G, $) {
    ...
    R = R.onMatch(function(match) {
      ...
      return G.new_node.x_relative_route(raw, match);
    });
  ...
  this.$new.new_node = function(G, $) {
    var RR;
    RR = {};
    RR.x_symbol = function(mark, raw, value) {
      var R;
    ...
    RR.x_relative_route = function(raw, value) {
      var R;
    ...
    RR.x_identifier_with_sigil = function(sigil, name) {
      var R;
    ...
    RR.x_identifier_without_sigil = function(name) {
      var R;
  ...
  this.$new.as = function(G, $) {
    ...
    RR.coffee = function(node) {
      var crumb, crumb_subtype, crumb_type, crumbs, idx, name, names, source, subtype, type, _i, _len;
  ...
  this.$TESTS = {
    ...
    'as.coffee: render route as CoffeeScript': function(test) {
    ...
    'as.js: render route as JavaScript': function(test) {
      var $, G, matcher, node, probe, probes_and_matchers, result, _i, _len, _ref, _results;
      G = this;
      $ = G.$;
      probes_and_matchers = [["foo/bar/!baz", "$FM['scope']['foo']['bar']['!baz'];\n"]];
    ...
    'as.standard: standardize route': function(test) {
      var $, G, matcher, node, probe, probes_and_matchers, result, _i, _len, _ref, _results;
      G = this;
      $ = G.$;
      probes_and_matchers = [
