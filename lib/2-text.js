...
(function() {
  ...
  this.$_nosq = (ƒ.repeat((function(_this) {
    return function() {
      return ƒ.or(_this.$_escaped, RegExp("[^" + (BNP.escape_regex(_this.$_constants['single-quote'])) + "]"));
    };
  ...
  this.$_nodq = (ƒ.repeat((function(_this) {
    return function() {
      return ƒ.or(_this.$_escaped, RegExp("[^" + (BNP.escape_regex(_this.$_constants['double-quote'])) + "]"));
    };
  })(this))).onMatch(function(match) {
    var submatch;
    return ((function() {
  ...
  this.$_unicode_hex = (ƒ.seq(this.$_unicode4_metachr, /[0-9a-fA-F]{4}/)).onMatch((function(_this) {
    return function(match) {
      return String.fromCharCode('0x' + match[1]);
    };
  })(this));

  this.$_escaped = (ƒ.seq(this.$_chr_escaper, ƒ.or(this.$_simple_escape, this.$_unicode_hex, this._chr))).onMatch((function(_this) {
    return function(match) {
      return match[1];
    };
  })(this));
  ...
  this.literal = (ƒ.or(this.$_sq_literal, this.$_dq_literal)).onMatch((function(_this) {
    return function(match) {
      var ignore, value;
