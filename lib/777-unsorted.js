...
(function() {
  var A, NUM, TRM, WS, alert, badge, debug, echo, help, info, log, rainbow, rpr, warn, whisper, π,
    __slice = [].slice;
  ...
  this.sum = π.alt(this.addition, NUM.digits);

  this.product = π.alt(this.multiplication, NUM.digits);
