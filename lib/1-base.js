...
(function() {
  var CHR, NEW, NUMBER, TEXT, TRM, XRE, alert, badge, debug, echo, help, info, log, rpr, warn, whisper, π;
  ...
  this.symbol = (π.seq(this.$_symbol_sigil, CHR.nws)).onMatch((function(_this) {
  ...
  this.use_statement = (π.seq(this.$_use_keyword, CHR.ilws, this.use_argument)).onMatch((function(_this) {
    return function(match) {
