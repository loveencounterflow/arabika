  ...
  this.constructor = function(G, $) {
    ...
    G.helpers.walk_chunkify_events_3 = function(source, handler) {
      ...
      adjust_content_level = function(content) {
        ...
        if (last_level > level) {
          content = content + (TEXT.repeat(closer, last_level - level));
    ...
    G.tests['helpers.walk_chunkify_events_1'] = function(test) {
      var source;
    ...
    G.tests['helpers.walk_chunkify_events_2'] = function(test) {
      var source;
      source = G.tests._sources[0];
    ...
    G.tests['helpers.walk_chunkify_events_3 (0)'] = function(test) {
      var source;
      source = G.tests._sources[0];
    ...
    G.tests['helpers.as_bracketed (0)'] = function(test) {
      var source;
      source = G.tests._sources[0];
    ...
    return G.tests['helpers.as_bracketed (2)'] = function(test) {
      var source;
      source = G.tests._sources[2];
      return debug(rpr(G.helpers.as_bracketed(source)));
    };
