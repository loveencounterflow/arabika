  ...
  this.constructor = function(G, $) {
    ...
    G.loop_statement = function() {
      return ƒ.seq((function() {
        ...
        var chunk, keyword, line, loop_keyword;
        loop_keyword = $['loop-keyword'];
        keyword = match[0], chunk = match[1];
        ...
        chunk = (function() {
          ...
          for (_i = 0, _len = chunk.length; _i < _len; _i++) {
            line = chunk[_i];
            _results.push($.LINE.line.run(line));
          }
          return _results;
        })();
    ...
    G.tests['as.coffee: render break statement'] = function(test) {
    ...
    return G.tests['as.coffee: render loop statement'] = function(test) {
