...
(function() {
  var GLOB, MULTIMIX, TRM, alert, badge, debug, echo, glob, help, info, log, modules, njs_path, rainbow, route, routes, rpr, warn, whisper, π,
    __slice = [].slice;
  ...
  modules = (function() {
    ...
    for (_i = 0, _len = routes.length; _i < _len; _i++) {
      route = routes[_i];
      _results.push(require(route));
    }
    return _results;
  })();

  module.exports = MULTIMIX.assemble.apply(MULTIMIX, [this].concat(__slice.call(modules)));
