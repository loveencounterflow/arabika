...
(function() {
  var TRM, TYPES, alert, badge, debug, echo, f, help, info, log, rainbow, rpr, warn, whisper, π,
    __slice = [].slice;
  ...
  f = function() {
    var add, arrow, ascii_digits, ascii_name, asciispaces, assignment_lhs, assignment_rhs, bare_function_def_head, bare_name_list, bare_return_statement, basic_ascii_name, comma, consume, csv, difference, division, double_fat_arrow, double_slim_arrow, empty_signature, exp_or_return, expr, expression, exps_or_returns, filled_function_def_head, filled_return_statement, filled_signature, function_def, function_def_head, id, inline_function_def, inline_function_def_body, lws, nocomma, notok, number, ok, one_asciispace, optional_asciispaces, optional_comma, parameter_separator, parse, parser, product, return_literal, return_statement, rv, show, show_parse_result, signature, signature_close, signature_open, single_fat_arrow, single_slim_arrow, source, staged_function_def, sum, sum_expr, test, test_for_comma, test_for_nocomma, two_asciispaces, two_n0_asciispaces, _clean_match;
    ascii_digits = /[0-9]+/;
    ...
    return info(π.parse(parser, 'abcx'));
  };
