  ...
  this.constructor = function(G, $) {
    ...
    G.route.as = {
      coffee: function(node) {
        var crumb, crumb_subtype, crumb_type, crumbs, idx, name, names, root_name, subtype, target, _i, _len;
    ...
    return G.tests['route: accepts crumbs with sigils'] = function(test) {
